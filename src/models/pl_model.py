...
class Model(SpatialVAE):
    ...
    def prepare_data(self):
        ...
        if self.dataset == 'MNIST':
            ...
            mnist_train = torchvision.datasets.MNIST('src/data/mnist/', train=True, download=True,
                                                     transform=transform).data.float()
            mnist_val = torchvision.datasets.MNIST('src/data/mnist/', train=False, download=True,
                                                   transform=transform).data.float()
